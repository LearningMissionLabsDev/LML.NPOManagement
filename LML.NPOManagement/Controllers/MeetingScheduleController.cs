...
namespace LML.NPOManagement.Controllers
{
    ...
    public class MeetingScheduleController : ControllerBase
    {
        ...
        private IMeetingScheduleService _meetingScheduleService;
        public MeetingScheduleController(IMeetingScheduleService meetingScheduleService)
        {
        ...
        // GET api/<MeetingScheduleController>/5
        [HttpGet("{id}")]
