...
namespace LML.NPOManagement.Controllers
{
    ...
    public class WeeklyScheduleController : ControllerBase
    {
        ...
        // GET: api/<WeeklyScheduleController>
        [HttpGet]
        ...
        // GET api/<WeeklyScheduleController>/5
        [HttpGet("{id}")]
        ...
        // POST api/<WeeklyScheduleController>
        [HttpPost]
        public void Post([FromBody] string value)
        {
        }

        // PUT api/<WeeklyScheduleController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<WeeklyScheduleController>/5
        [HttpDelete("{id}")]
