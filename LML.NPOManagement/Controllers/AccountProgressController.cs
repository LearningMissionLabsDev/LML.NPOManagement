...
namespace LML.NPOManagement.Controllers
{
    ...
    public class AccountProgressController : ControllerBase
    {
        ...
        private IAccountProgressService _accountProgressService;

        public AccountProgressController(IAccountProgressService accountProgressService)
        {
            ...
            _accountProgressService = accountProgressService;
        }
        // GET: api/<AccountProgressController>
        [HttpGet]
        ...
        // GET api/<AccountProgressController>/5
        [HttpGet("{id}")]
        ...
        // POST api/<AccountProgressController>
        [HttpPost]
        public void Post([FromBody] string value)
        {
        }

        // PUT api/<AccountProgressController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<AccountProgressController>/5
        [HttpDelete("{id}")]
