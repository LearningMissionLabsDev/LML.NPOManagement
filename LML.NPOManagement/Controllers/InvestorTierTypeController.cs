...
namespace LML.NPOManagement.Controllers
{
    ...
    [ApiController]
    public class InvestorTierTypeController : ControllerBase
    {
        private IMapper _mapper;
        private IInvestorTierTypeService _investorTierTypeService;
        public InvestorTierTypeController(IInvestorTierTypeService investorTierTypeService)
        {
            ...
            _investorTierTypeService = investorTierTypeService;
        }
        // GET: api/<InvestorTierTypeController>
        [HttpGet]
        ...
        // GET api/<InvestorTierTypeController>/5
        [HttpGet("{id}")]
        ...
        // POST api/<InvestorTierTypeController>
        [HttpPost]
        public void Post([FromBody] string value)
        {
        }

        // PUT api/<InvestorTierTypeController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<InvestorTierTypeController>/5
        [HttpDelete("{id}")]
