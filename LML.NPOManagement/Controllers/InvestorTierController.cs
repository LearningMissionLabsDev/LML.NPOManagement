...
namespace LML.NPOManagement.Controllers
{
    ...
    [ApiController]
    public class InvestorTierController : ControllerBase
    {
        private IMapper _mapper;
        private IInvestorTierService _investorTierService;
        public InvestorTierController(IInvestorTierService investorTierService)
        {
            ...
            _investorTierService = investorTierService;
        }
        // GET: api/<InvestorTierController>
        [HttpGet]
        ...
        // GET api/<InvestorTierController>/5
        [HttpGet("{id}")]
        ...
        // POST api/<InvestorTierController>
        [HttpPost]
        public void Post([FromBody] string value)
        {
        }

        // PUT api/<InvestorTierController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<InvestorTierController>/5
        [HttpDelete("{id}")]
