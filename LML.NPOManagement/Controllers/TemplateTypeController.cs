...
namespace LML.NPOManagement.Controllers
{
    ...
    public class TemplateTypeController : ControllerBase
    {
        ...
        public TemplateTypeController(ITemplateTypeService templateTypeService)
        {
        ...
        // GET: api/<TemplateTypeController>
        [HttpGet]
        ...
        // GET api/<TemplateTypeController>/5
        [HttpGet("{id}")]
        ...
        // POST api/<TemplateTypeController>
        [HttpPost]
        public void Post([FromBody] string value)
        {
        }

        // PUT api/<TemplateTypeController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<TemplateTypeController>/5
        [HttpDelete("{id}")]
