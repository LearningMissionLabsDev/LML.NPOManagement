...
namespace LML.NPOManagement.Controllers
{
    ...
    public class DailyScheduleController : ControllerBase
    {
        ...
        // GET: api/<DailyScheduleController>
        [HttpGet]
        ...
        // GET api/<DailyScheduleController>/5
        [HttpGet("{id}")]
        ...
        // POST api/<DailyScheduleController>
        [HttpPost]
        public void Post([FromBody] string value)
        {
        }

        // PUT api/<DailyScheduleController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<DailyScheduleController>/5
        [HttpDelete("{id}")]
