    ...
    public partial class NPOManagementContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //                optionsBuilder.UseSqlServer("server=localhost;database=NPOManagement;trusted_connection=true; encrypt=false");
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasMany(d => d.Groups)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        r => r.HasOne<User>().WithMany().HasForeignKey("UserId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__UserGroup__UserI__18EBB532"),
                        j =>
                        {
                            j.HasKey("UserId", "GroupId").HasName("PK__UserGrou__A6C1637A4C6152BD");
